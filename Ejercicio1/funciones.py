...
def test(lista):
    ...
    for i in range(3):
        ...
        c = CajaDeAhorro(nroc,nom,apell,cuit,saldo)
    ...
    while c.validarCUIL(dato) == False:
        
        print("Validacion  Incorrecta! Vuelva a Ingresar el CUIL.")
        dato = input("Ingrese su CUIL: ")
    else:
...
def CuentaBancaria():
    ...
    cuil = input("Ingrese Nro de Cuil:")
